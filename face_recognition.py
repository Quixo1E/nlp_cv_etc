...
facerec_model = Sequential(
    ...
    Conv2D(64, kernel_size=(3, 3), strides=(1, 1), activation='ReLU', name='conv_1'),   # Use 64 conv. filters of size 3x3 and shift them in 1-pixel steps
    Conv2D(32, kernel_size=(3, 3), strides=(1, 1), activation='ReLU', name='conv_2'),   # Use 32 conv. filters of size 3x3x64 because the input has 64 channels
    BatchNormalization(),
    ...
    Dense(100, activation='ReLU', name='dense_layer_1'),    # A dense layer of 100 neurons ("dense" implies complete connections to all of its inputs) 
    Dropout(0.3),
    BatchNormalization(),
...
"""Train the model and record data using TensorBoard"""
...
"""Get the network's class prediction and its confidence for all test inputs  """
...
"""Inspect individual classification results"""
